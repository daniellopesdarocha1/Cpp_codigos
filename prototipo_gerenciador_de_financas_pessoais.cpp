...
int main(){
	...
	//soma_diagonal_secundaria += M[0][4];
	//soma_diagonal_secundaria += M[1][3];
	//soma_diagonal_secundaria += M[2][2];
	//soma_diagonal_secundaria += M[3][1];
	//soma_diagonal_secundaria += M[4][0];
	...
	cout << "\nSoma de todos os elementos: " << soma_todos_elementos;
	...
	printf( "\nCapacidade da pilha: %d", capacidade );
	//scanf( "%d", &capacidade );
	...
	while( 1 ){ /* loop infinito */
		...
		printf("3- Mostrar somas que foram empilhadas \n");
		printf("4- sair\n");
		printf("\nopcao? ");
		scanf("%d", &op);
